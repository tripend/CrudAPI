...
import com.example.CrudAPI.services.TodoService;
...
public class TodoController {
    ...
    //The function receives a GET request, processes it and gives back a list of a Todo
    @GetMapping
    ...
    //The function receives a GET request, processes it, and returns the TODO with the specified Id
    @GetMapping({"/{todoId}"})
    public ResponseEntity<Todo> getTodo(@PathVariable Long todoId) {
        return new ResponseEntity<>(todoService.getTodoById(todoId), HttpStatus.OK);
    }
    //The function receives a POST request, processes it, creates a new
    // Todo and saves it to the database, and returns a resource link to the created todo.
    @PostMapping
